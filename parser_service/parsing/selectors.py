class CSS:
    ...
    Связь с PageType:
    - SIGNATURE_* -> используются в BaseParser._classify_page() для определения PageType  # noqa: E501
    ...
    SERP_ITEM = (
        "#pjax-resume-list div.card, #pjax-resume-list div.card-visited"
    )
    ...
    SERP_NEXT_PAGE = "ul.pagination li a i.glyphicon-chevron-right, ul.pagination a[rel='next']"  # noqa: E501
    ...
    RESUME_H1 = "h1"  # Имя
    RESUME_POSITION = (
        "h1 ~ h2, h2.title-print"  # Шукає перший h2 одразу після h1 (Ім'я)
    )
    ...
    # value:  <span class="dt-print-desc">CMO, Маркетолог, ...</span> (usually
    # in the next <tr>)
