...
def compress_vacancy_to_query(
    vacancy_text: str, llm_chat: Callable[[Sequence[Dict[str, str]]], str]
) -> str:
    """
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a helpful assistant that extracts key information from job postings.",
        },
        {
            "role": "user",
            "content": f"""
